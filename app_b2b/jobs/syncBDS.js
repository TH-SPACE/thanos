...
async function executarSincronizacao() {
    ...
    try {
        ...
        try {
            ...
            // Mapeamento de campos da API para o banco (ORDEM DO JSON - NOVA ESTRUTURA)
            const mapeamentoCampos = {
                'BD': 'bd',
                'bd_raiz': 'bd_raiz',
                'protocolo_crm': 'protocolo_crm',
                'ID_VANTIVE': 'id_vantive',
                'STATUS': 'status_nome',
                'tipo_ngem': 'tipo_ngem',
                'procedencia': 'procedencia',
                'reclamacao': 'reclamacao',
                'SEGMENTO_SIGITM': 'segmento_sistema',
                'SEGMENTO_COMERCIAL': 'segmento_comercial',
                'SEGMENTO_COMERCIAL_NOVO': 'segmento_novo',
                'segmento_v3': 'segmento_v3',
                'atendimento_valor': 'atendimento_valor',
                'SLM_FLAG': 'slm_flag',
                ...
                'CNL': 'localidade_codigo',
                'AREA': 'area_codigo',
                'ESCRITORIO': 'escritorio_codigo',
                'ENDERECO': 'endereco',
                'cidade': 'cidade',
                'uf': 'uf',
                'cluster': 'cluster',
                ...
                'data_abertura_dia_semana': 'data_abertura_dia_semana',
                'data_abertura_dia': 'data_abertura_dia',
                'data_abertura_mes': 'data_abertura_mes',
                'data_abertura_ano': 'data_abertura_ano',
                'MES_ANO_ABERTURA': 'mes_ano_abertura',
                'data_reparo': 'data_reparo',
                'data_reparo_dia_semana': 'data_reparo_dia_semana',
                'data_reparo_dia': 'data_reparo_dia',
                'data_reparo_mes': 'data_reparo_mes',
                'data_reparo_ano': 'data_reparo_ano',
                'data_encerramento': 'data_encerramento',
                'data_encerramento_dia_semana': 'data_encerramento_dia_semana',
                'data_encerramento_dia': 'data_encerramento_dia',
                'data_encerramento_mes': 'data_encerramento_mes',
                'data_encerramento_ano': 'data_encerramento_ano',
                'MES_ANO_ENC': 'mes_ano_enc',
                'data_baixa': 'data_baixa',
                'data_baixa_dia_semana': 'data_baixa_dia_semana',
                'data_baixa_dia': 'data_baixa_dia',
                'data_baixa_mes': 'data_baixa_mes',
                'data_baixa_ano': 'data_baixa_ano',
                'baixa_n1_codigo': 'baixa_n1_codigo',
                'BAIXA_N1': 'baixa_n1_nome',
                'baixa_n2_codigo': 'baixa_n2_codigo',
                'BAIXA_N2': 'baixa_n2_nome',
                'baixa_n3_codigo': 'baixa_n3_codigo',
                'BAIXA_N3': 'baixa_n3_nome',
                'baixa_n4_codigo': 'baixa_n4_codigo',
                'BAIXA_N4': 'baixa_n4_nome',
                'baixa_n5_codigo': 'baixa_n5_codigo',
                'BAIXA_N5': 'baixa_n5_nome',
                'BAIXA_CODIGO': 'baixa_codigo',
                'resumo_intragov': 'resumo_intragov',
                'intragov_sigla': 'intragov_sigla',
                'intragov_codigo': 'intragov_codigo',
                'acionamento_tecnico': 'acionamento_tecnico',
                'acionamento_operadora': 'acionamento_operadora',
                'acionamento_integradora': 'acionamento_integradora',
                'acionamento_parceiro': 'acionamento_parceiro',
                'acionamento_transmissao': 'acionamento_transmissao',
                'acionamento_ccr': 'acionamento_ccr',
                'acionamento_osp': 'acionamento_osp',
                'acionamento_diag_b2b': 'acionamento_diag_b2b',
                'sla_horas': 'sla_horas',
                'sla_tipo': 'sla_tipo',
                'GRUPO_MIS': 'grupo',
                'GRUPO_PER_B2B': 'grupo_novo',
                'FOCO_MIS': 'foco_acoes',
                'FOCO_PER_B2B': 'foco_novo',
                ...
                'massiva_flag': 'massiva_flag',
                'TMR_MIN': 'tmr',
                'prazo': 'prazo',
                'TEMPO_PARADA_MIN': 'tempo_parada',
                'REINC_30D': 'reincidencia_30d',
                'REINC_30D_GRUPO': 'reincidencia_30d_grupo',
                'REINC_TIPO': 'reincidencia_tipo',
                'originou_reinc': 'originou_reinc',
                'REINC_30D_ATACADO': 'reincidencia_30d_atacado',
                'REINC_TIPO_ATACADO': 'reincidencia_tipo_atacado',
                'REINC_30D_ACESSO': 'reincidencia_30d_acesso',
                'REINC_TIPO_ACESSO': 'reincidencia_tipo_acesso',
                'prox_reinc': 'prox_reinc',
                'originou_reinc_grupo': 'originou_reinc_grupo',
                'prox_reinc_grupo': 'prox_reinc_grupo',
                'maior_doze_flag': 'maior_doze_flag',
                ...
                'projeto': 'projeto',
                'top_atacado': 'top_atacado',
                'tj': 'tj',
                'last_update': 'last_update',
                'decorrido_sem_parada': 'tmr_sem_parada',
                'TRIAGEM_FLAG': 'triagem_flag',
                'PLANTA_FLAG': 'planta_flag',
                'tipo_acesso': 'tipo_acesso',
                'contato_nome': 'contato_nome',
                'reclamante_nome': 'reclamante_nome',
                'reclamante_telefone': 'reclamante_telefone',
                'contato_telefone': 'contato_telefone',
                'flag_intragov': 'flag_intragov',
                'R30_Tratativas': 'R30_Tratativas',
                'tmr_exp_reparo_min': 'tmr_exp_reparo_min',
                'tmr_exp_min': 'tmr_exp_min',
